...
c = Cocktail.create(username: u, ingredients: "whiskey, 2 dashes Angostura bitters, one sugarcube, few dashes plain water", name: "old fashioned", private_note: "magnificent")
